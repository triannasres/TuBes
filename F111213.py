...
def riwayatpinjam():   
    ...
    #sort tanggal
    sortedtanggal=[[ 0 for i in range (2)] for j in range (len(gadget_borrow_history_matrix))]
    ...
    print(sortedtanggal)
    print(gadget_borrow_history_matrix)
    print(user_matrix)
    print(gadget_matrix)
...
def riwayatkembali():
    ...
    #sort tanggal
    sortedtanggal=[[0 for i in range (2)] for j in range (len(gadget_return_history_matrix))]
    for i in range (1, len(gadget_return_history_matrix)):
        sortedtanggal[i-1][0]=int(gadget_return_history_matrix[i][2][6]+gadget_return_history_matrix[i][2][7]+gadget_return_history_matrix[i][2][8]+gadget_return_history_matrix[i][2][9]+gadget_return_history_matrix[i][2][3]+gadget_return_history_matrix[i][2][4]+gadget_return_history_matrix[i][2][0]+gadget_return_history_matrix[i][2][1])
    ...
    print(sortedtanggal)
    print(gadget_return_history_matrix)
    print(user_matrix)
    print(gadget_matrix)
                    ...
                    if (gadget_borrow_history_matrix[k][0])==(gadget_return_history_matrix[j][1]):
                        ...
                        for l in range (len(gadget_matrix)):
                            if (gadget_matrix[l][0])== (gadget_borrow_history_matrix[k][2]): #mencocokkan nama gadget
                                print("Nama Gadget         :", gadget_matrix[l][1])
                        print("Tanggal Pengembalian:", gadget_return_history_matrix[j][2], "\n")
...
def riwayatambil():
    ...
    #sort tanggal
    sortedtanggal=[[0 for i in range (2)] for j in range (len(consumable_history_matrix))]
    ...
    print(sortedtanggal)
    print(consumable_history_matrix)
    print(user_matrix)
    print(consumable_matrix)
